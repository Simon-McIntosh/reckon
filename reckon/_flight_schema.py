...
class BackendConfig(ConfiguredBaseModel):
    ...
    input_rate_per_million: Optional[float] = Field(default=None, description="""Published input-token rate per million tokens used only to derive dimensionless quota comparisons. Optional operator data; absence leaves this backend explicitly unpriced.""", ge=0)
    output_rate_per_million: Optional[float] = Field(default=None, description="""Published output-token rate per million tokens used only to derive dimensionless quota comparisons. Optional operator data; absence leaves this backend explicitly unpriced.""", ge=0)
